...
public class PublishMarketplaceListingRequestDto {

    @NotNull(message = "TC ID is required.")
    @Positive(message = "TC ID must be positive.")
    private Long tcId;
    ...
    public PublishMarketplaceListingRequestDto() {
    }

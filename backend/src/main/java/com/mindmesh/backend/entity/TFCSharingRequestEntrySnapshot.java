...
@Entity
@Table(
    name = "tfc_sharing_request_entry_snapshots",
    indexes = {
        @Index(
            name = "idx_tfc_sharing_request_entry_snapshots_item_id",
            columnList = "sharing_request_item_id"
        )
    }
)
public class TFCSharingRequestEntrySnapshot {
    ...
    private TFCSharingRequestItem sharingRequestItem;
    ...
    protected TFCSharingRequestEntrySnapshot() {
        // Required by JPA.
    }

    public TFCSharingRequestEntrySnapshot(
        TFCSharingRequestItem sharingRequestItem,
    ...
    void setSharingRequestItem(TFCSharingRequestItem sharingRequestItem) {
        this.sharingRequestItem = sharingRequestItem;
    }
    ...
    public TFCSharingRequestItem getSharingRequestItem() {
